...
public class PublishedFilesChart implements Serializable {
    ...
    private static final String CHART_TYPE = "files";
    ...
    @Inject
    public PublishedFilesChart(ChartCreator chartCreator, MetricsServiceBean metricsService, ChartTableCreator chartTableCreator) {
