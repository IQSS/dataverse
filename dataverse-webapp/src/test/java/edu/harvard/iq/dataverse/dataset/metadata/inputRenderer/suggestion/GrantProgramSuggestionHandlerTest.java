...
public class GrantProgramSuggestionHandlerTest {

    @InjectMocks
    private GrantProgramSuggestionHandler grantProgramSuggestionHandler;
    ...
    public void generateSuggestions() {
        ...
        //when
        List<Suggestion> suggestions = grantProgramSuggestionHandler.generateSuggestions(
        ...
        verify(grantSuggestionDao).fetchSuggestions(
                ImmutableMap.of("filterField", "filterValue"), GrantSuggestion.FUNDING_PROGRAM_COLUMN, "query", 10);
    }
}
