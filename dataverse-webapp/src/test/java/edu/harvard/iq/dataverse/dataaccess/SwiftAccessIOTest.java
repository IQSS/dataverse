...
public class SwiftAccessIOTest {
    ...
    public void testToHexString() {
        ...
        assertEquals("68656c6c6f", SwiftAccessIO.toHexString(bytes));
    }

    @Test
    public void testCalculateRFC2104HMAC() throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
        assertEquals("104152c5bfdca07bc633eebd46199f0255c9f49d", SwiftAccessIO.calculateRFC2104HMAC("data", "key"));
    }
}
