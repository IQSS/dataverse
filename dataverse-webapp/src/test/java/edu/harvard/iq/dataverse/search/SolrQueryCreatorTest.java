...
class SolrQueryCreatorTest {
    ...
    public void constructQuery_LicenseQuery() {
        ...
        doAnswer(invocation ->
                invocation.getArgument(0).equals(1L)
                    ? license1
                    : invocation.getArgument(0).equals(2L)
                        ? license2
                        : null)
    ...
    private List<SearchField> createCheckboxLicenseSearchFields() {
        CheckboxSearchField testValue1 = new CheckboxSearchField(createType("license", "checkboxLicenseValues", "desc"));
    ...
    private DatasetFieldType createType(String name, String displayName, String description) {
