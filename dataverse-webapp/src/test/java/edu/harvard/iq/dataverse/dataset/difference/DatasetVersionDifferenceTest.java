...
public class DatasetVersionDifferenceTest {
    ...
    public void create_WITH_REPLACED_FILE() throws IOException, JsonParseException {
        ...
        assertEquals(String.valueOf(dataFileToReplace.getId()),
                     dataFileDiffReplacement.getOldFileSummary().getFileId());
        assertEquals(String.valueOf(dataFileReplacement.getId()),
                     dataFileDiffReplacement.getNewFileSummary().getFileId());
