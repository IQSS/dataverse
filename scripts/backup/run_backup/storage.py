...
def open_dataverse_file(dataset_authority, dataset_identifier, storage_identifier):
    ...
    if storageTag == 'file':
        byteStream = open_storage_object_filesystem(dataset_authority, dataset_identifier, objectLocation)
        return byteStream
    elif storageTag == 's3':
