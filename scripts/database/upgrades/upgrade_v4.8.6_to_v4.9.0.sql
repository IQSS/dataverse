...
UPDATE dvobject SET identifier=substring(authority, strpos(authority,doiseparator)+1) || doiseparator || identifier WHERE strpos(authority,doiseparator)>0 and doiseparator != '' and doiseparator is not null;
UPDATE dvobject SET authority=substring(authority from 0 for strpos(authority,doiseparator)) WHERE strpos(authority,doiseparator)>0 and doiseparator != '' and doiseparator is not null;
