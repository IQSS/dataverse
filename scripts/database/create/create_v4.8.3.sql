...
CREATE TABLE OAUTH2TOKENDATA (ID  SERIAL NOT NULL, ACCESSTOKEN VARCHAR(64), EXPIRYDATE TIMESTAMP, OAUTHPROVIDERID VARCHAR(255), RAWRESPONSE TEXT, REFRESHTOKEN VARCHAR(64), SCOPE VARCHAR(64), TOKENTYPE VARCHAR(32), USER_ID BIGINT, PRIMARY KEY (ID))
