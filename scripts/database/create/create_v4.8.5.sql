...
CREATE TABLE EXTERNALTOOL (ID  SERIAL NOT NULL, DESCRIPTION TEXT, DISPLAYNAME VARCHAR(255) NOT NULL, TOOLPARAMETERS VARCHAR(255) NOT NULL, TOOLURL VARCHAR(255) NOT NULL, PRIMARY KEY (ID))
