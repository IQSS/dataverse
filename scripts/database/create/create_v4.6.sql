CREATE TABLE AUTHENTICATEDUSER (ID  SERIAL NOT NULL, AFFILIATION VARCHAR(255), EMAIL VARCHAR(255) NOT NULL UNIQUE, EMAILCONFIRMED TIMESTAMP, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), MODIFICATIONTIME TIMESTAMP, POSITION VARCHAR(255), SUPERUSER BOOLEAN, USERIDENTIFIER VARCHAR(255) NOT NULL UNIQUE, PRIMARY KEY (ID))
...
CREATE TABLE DATASET (ID BIGINT NOT NULL, AUTHORITY VARCHAR(255), DOISEPARATOR VARCHAR(255), FILEACCESSREQUEST BOOLEAN, GLOBALIDCREATETIME TIMESTAMP, HARVESTIDENTIFIER VARCHAR(255), IDENTIFIER VARCHAR(255) NOT NULL, LASTEXPORTTIME TIMESTAMP, PROTOCOL VARCHAR(255), citationDateDatasetFieldType_id BIGINT, harvestingClient_id BIGINT, guestbook_id BIGINT, thumbnailfile_id BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE DATAFILE (ID BIGINT NOT NULL, CHECKSUMTYPE VARCHAR(255) NOT NULL, CHECKSUMVALUE VARCHAR(255) NOT NULL, CONTENTTYPE VARCHAR(255) NOT NULL, FILESYSTEMNAME VARCHAR(255) NOT NULL, FILESIZE BIGINT, INGESTSTATUS CHAR(1), NAME VARCHAR(255), RESTRICTED BOOLEAN, PRIMARY KEY (ID))
