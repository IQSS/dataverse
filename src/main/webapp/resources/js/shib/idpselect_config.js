...
//    this.defaultReturn = null;       // If non null, then the default place to send users who are not
    ...
    this.langBundles = {
        'en': {
            ...
            'idpEntry.NoPreferred.label': 'Please use your institutional log in via SURFconext authentication system, to create a DataverseNL account and to log in.',
            'idpList.label': 'Or select your institution from the list below.',
            'idpList.NoPreferred.label': 'Please use your institutional log in via SURFconext authentication system, to create a DataverseNL account and to log in.',
