...
if(params.widget === 'iframe') {
     ...
     */
    document.write('<iframe src="' + params.dvUrl + '/iframe.xhtml?alias=' + params.alias + '" width="100%" height="500" style="padding:12px; border-top: #ddd 1px solid; border-right: #ddd 1px solid; border-left: #ddd 1px solid; border-bottom: #ddd 1px solid; -moz-border-radius: 4px; -webkit-border-radius: 12px; border-radius: 4px; background: url(' + params.dvUrl + '/resources/images/ajax-loading.gif) no-repeat 50% 50%;"></iframe>');
}
