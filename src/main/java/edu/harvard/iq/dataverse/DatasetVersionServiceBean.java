...
public class DatasetVersionServiceBean implements java.io.Serializable {
     ...
     *
     * Used to help display messages in the cases when: (1) A specific dataset
     * version (including a DRAFT) is requested (2) A different dataset is
     * returned b/c the first one doesn't exist
     *
     * Simple example: "DRAFT" requested but no longer exists b/c it was
     * published and is now version "1.0"
     */
     ...
     *
     * @param version
     * @return Long[] with [ major_version, minor_version ] - either or both may
     * be null
     */
     ...
     *
     * @param identifierClause - query clause to retrieve via DatasetVersion.Id
     * or DatasetVersion.persistentId
