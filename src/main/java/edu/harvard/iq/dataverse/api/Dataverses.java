...
public class Dataverses extends AbstractApiBean {
    ...
    public Response createDataset(String jsonBody, @PathParam("identifier") String parentIdtf, @QueryParam("doNotValidate") String doNotValidateParam) {
        try {
            ...
            ds.setOwner(owner);
            boolean skipValidation = u.isAuthenticated() && StringUtil.isTrue(doNotValidateParam) && settingsService.isTrueForKey(SettingsServiceBean.Key.AllowInvalidMetadataThroughAPI, false);
