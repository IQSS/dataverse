...
public enum JvmSettings {
    ...
    CROSSREF_REST_API_URL(SCOPE_PID_PROVIDER, "rest-api-url"),
    CROSSREF_USERNAME(SCOPE_PID_PROVIDER, "username"),
    CROSSREF_PASSWORD(SCOPE_PID_PROVIDER, "password"),
    CROSSREF_DEPOSITOR(SCOPE_PID_PROVIDER, "depositor"),
    CROSSREF_DEPOSITOR_EMAIL(SCOPE_PID_PROVIDER, "depositor-email"),
