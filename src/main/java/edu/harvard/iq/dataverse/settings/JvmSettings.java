...
public enum JvmSettings {
    ...
    // AUTH: OIDC KEYCLOAK GROUP -> ROLE SYNCHRONISATION
    SCOPE_OIDC_SYNC(SCOPE_OIDC, "sync"),
    OIDC_SYNC_ENABLED(SCOPE_OIDC_SYNC, "enabled"),
    OIDC_SYNC_GROUPS_CLAIM(SCOPE_OIDC_SYNC, "groups-claim"),
    OIDC_SYNC_REALM(SCOPE_OIDC_SYNC, "realm"),
    OIDC_SYNC_SERVER_URL(SCOPE_OIDC_SYNC, "server-url"),
    OIDC_SYNC_CLIENT_ID(SCOPE_OIDC_SYNC, "client-id"),
    OIDC_SYNC_CLIENT_SECRET(SCOPE_OIDC_SYNC, "client-secret"),
    OIDC_SYNC_PARENT_GROUP(SCOPE_OIDC_SYNC, "parent-group"),
    OIDC_SYNC_TENANTS_GROUP(SCOPE_OIDC_SYNC, "tenants-group"),
    OIDC_SYNC_SUPERUSER_GROUP(SCOPE_OIDC_SYNC, "superuser-group"),
    OIDC_SYNC_ALIAS_ATTRIBUTE(SCOPE_OIDC_SYNC, "alias-attribute"),
    OIDC_SYNC_GROUP_PREFIX(SCOPE_OIDC_SYNC, "group-prefix"),
    OIDC_SYNC_ROLE_ADMIN(SCOPE_OIDC_SYNC, "role-admin"),
    OIDC_SYNC_ROLE_CURATOR(SCOPE_OIDC_SYNC, "role-curator"),
