...
public class CreateDatasetCommand extends AbstractCommand<Dataset> {
    ...
    public Dataset execute(CommandContext ctxt) throws CommandException {
        ...
        logger.log(Level.FINE, "after validation {0}", formatter.format(new Date().getTime())); // TODO remove
        ...
        logger.log(Level.FINE, "after datascrub {0}", formatter.format(new Date().getTime()));        
