...
public class DataRetriever extends AbstractApiBean {
    ...
    public String retrieveMyDataAsJsonString(@QueryParam("dvobject_types") List<String> dvobject_types, 
        ...
        if (filterParams.hasError()){
            jsonData.add(DataRetriever.JSON_SUCCESS_FIELD_NAME, false);
            jsonData.add(DataRetriever.JSON_ERROR_MSG_FIELD_NAME, filterParams.getErrorMessage());
            return jsonData.build().toString();
        }
        ...
        if (myDataFinder.hasError()){
            jsonData.add(DataRetriever.JSON_SUCCESS_FIELD_NAME, false);
            jsonData.add(DataRetriever.JSON_ERROR_MSG_FIELD_NAME, myDataFinder.getErrorMessage());
            return jsonData.build().toString();
        }
        ...
        if (solrQueryResponse==null){
            jsonData.add(DataRetriever.JSON_SUCCESS_FIELD_NAME, false);
            jsonData.add(DataRetriever.JSON_ERROR_MSG_FIELD_NAME, "Sorry!  There was a SOLR Error");
            return jsonData.build().toString();
        }
        
        //jsonData.add(DataRetriever.JSON_DATA_FIELD_NAME, Json.createObjectBuilder()
        //jsonData.add(DataRetriever.JSON_DATA_FIELD_NAME, Json.createObjectBuilder()
        ...
        jsonData.add(DataRetriever.JSON_DATA_FIELD_NAME,        
