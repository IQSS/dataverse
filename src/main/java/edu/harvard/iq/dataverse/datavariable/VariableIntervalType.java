 ...
 *  
 * Largely based on the VariableIntervalType entity from the DVN v2-3;
 * original author: Ellen Kraffmiller (2006).
 * 
 */

@Entity
public class VariableIntervalType implements Serializable {
    /*
     * Simple constructor: 
     */
    ...
    public String toString() {
        return "edu.harvard.iq.dataverse.VariableIntervalType[ id=" + id + " ]";
    }
