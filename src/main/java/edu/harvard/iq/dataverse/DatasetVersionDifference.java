...
public class DatasetVersionDifference {
    ...
    private List<FileMetadata> addedFiles = new ArrayList<FileMetadata>();
    private List<FileMetadata> removedFiles = new ArrayList<FileMetadata>();
    private List<FileMetadata> changedFileMetadata = new ArrayList<FileMetadata>();
    private List<Object[]> summaryDataForNote = new ArrayList<Object[]>();
    private List<Object[]> blockDataForNote = new ArrayList<Object[]>();
