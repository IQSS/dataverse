...
public class DatasetFieldConstant implements java.io.Serializable  {
    ...
    public static final String keywordVocab="keywordVocabulary"; //SEK 6/10/2016 to match what is in the db
    public static final String keywordVocabURI="keywordVocabularyURI"; //SEK 6/10/2016 to match what is in the db
    ...
    public static final String northLatitude="northLongitude"; //Changed to match DB - incorrectly entered into DB: https://github.com/IQSS/dataverse/issues/5645
    public static final String southLatitude="southLongitude"; //Incorrect in DB: https://github.com/IQSS/dataverse/issues/5645
