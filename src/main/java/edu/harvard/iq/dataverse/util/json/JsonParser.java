...
public class JsonParser {
    ...
    /**
     * Special processing for GeographicCoverage compound field: Handle parsing
     * exceptions caused by invalid controlled vocabulary in the "country" field
     * by putting the invalid data in "otherGeographicCoverage" in a new
     * compound value.
     *
     * @param ex - contains the invalid values to be processed
     * @return a compound DatasetField that contains the newly created values,
     * in addition to the original valid values.
    ...
    /**
     * Special processing of keywords and subjects. All keywords and subjects
     * will be input from foreign formats (DDI, dcterms, etc) as keywords. As
     * part of the parsing, we will move keywords that match subject controlled
     * vocabulary values into the subjects datasetField.
     *
