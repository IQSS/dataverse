...
public class DatasetPage implements java.io.Serializable {
    ...
    private List<DataFile> newFiles = new ArrayList<DataFile>();
    ...
    private List<Template> dataverseTemplates = new ArrayList<Template>();
...
//delete for files that have been injested....
    ...
    private List<DatasetVersion> versionTabList = new ArrayList<DatasetVersion>();
    ...
    private List<DatasetVersion> releasedVersionTabList = new ArrayList<DatasetVersion>();
    ...
    private List<DatasetVersion> resetVersionTabList() {
        List<DatasetVersion> retList = new ArrayList<DatasetVersion>();
