...
public final class FileVersionDifference {
    ...
    public boolean compareMetadata(FileMetadata newFileMetadata, FileMetadata originalFileMetadata) {
        ...
        /*
         * This method both determines if there has been a change in file metadata
         * between the two versions supplied and it updates the FileVersionDifference
         * object which is used to display the differences on the dataset versions tab.
         * The return value is used by the index service bean to mark whether a file
         * needs to be re-indexed in the context of a dataset update. When there are
         * changes (after v4.19)to the file metadata data model this method must be
         * updated. retVal of True means metadatas are equal.
         */
