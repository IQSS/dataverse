...
class PartiallyOrderedSet extends AbstractSet<Object> {
    ...
    private Map<Object, DigraphNode> poNodes = new HashMap<Object, DigraphNode>();
...
class PartialOrderIterator implements Iterator<Object> {
    ...
    LinkedList<DigraphNode> zeroList = new LinkedList<DigraphNode>();
    Map<DigraphNode, Integer> inDegrees = new HashMap<DigraphNode, Integer>(); // DigraphNode -> Integer
