...
public class BrandingUtilTest {
    ...
    public void testWelcomeInAppNotification() {
        ...
        assertEquals("Welcome to LibraScholar! Get started by adding or finding data. "
                ...
                + " Want to test out Dataverse Software features? Use our <a href=\"https://demo.dataverse.org\">Demo Site</a>."
    ...
    public void testWelcomeEmail() {
        ...
        System.out.println("message: " + message);
        assertEquals("Welcome to LibraScholar! Get started by adding or finding data. "
                + "Have questions? Check out the Dataverse Software User Guides at http://guides.librascholar.edu/en/4.3/user or"
