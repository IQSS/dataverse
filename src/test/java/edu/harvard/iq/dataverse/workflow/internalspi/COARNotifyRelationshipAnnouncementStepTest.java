...
class COARNotifyRelationshipAnnouncementStepTest {
    ...
    private static DatasetFieldType multiValueFieldType;
    private static DatasetFieldType singleValueFieldType;
    private static DatasetFieldType compoundFieldType;
    private static DatasetFieldType childFieldType1;
    private static DatasetFieldType childFieldType2;

    @BeforeAll
    static void setUpFieldTypes() {
        // Setup field types
