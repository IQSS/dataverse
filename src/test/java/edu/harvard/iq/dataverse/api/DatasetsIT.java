...
public class DatasetsIT {
    ...
    public static void setUpClass() {
        ...
        Response remove = UtilIT.deleteSetting(SettingsServiceBean.Key.DoiIdentifierGetsDatasetDatabaseId);
    ...
    public void testDatasetHasDatabaseIdAsIdentifier() {
        ...
        Response datasetsShouldUseDatabaseIdAsIdentifier = UtilIT.setSetting(SettingsServiceBean.Key.DoiIdentifierGetsDatasetDatabaseId, "true");
        ...
        String identifier = JsonPath.from(datasetAsJson.getBody().asString()).getString("data.identifier");
        System.out.println("identifier: " + identifier);
        assertEquals(datasetId.toString(), identifier);
