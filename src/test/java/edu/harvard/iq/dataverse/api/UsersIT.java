...
//        String password = "sha-1Pass";
    ...
    public void testDeleteAuthenticatedUser() {
        ...
        deleteUserCreateDV.then().assertThat()
                .statusCode(BAD_REQUEST.getStatusCode())
                .body("message", equalTo("Could not delete Authenticated User @" + usernameForCreateDV + " because the user has created object(s) in this Dataverse installation; the user is associated with role assignment record(s)."));
