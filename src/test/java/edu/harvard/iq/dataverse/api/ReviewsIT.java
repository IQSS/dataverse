...
public class ReviewsIT {
    ...
    private static void ensureDatasetTypeIsPresent(String name, String displayName, String description,
        ...
        String jsonIn = NullSafeJsonBuilder.jsonObjectBuilder()
                ...
                .add("linkedMetadataBlocks", JsonUtil.createArrayBuilder()
                        .add("review")
                )
                .build().toString();
    ...
    public void testLocalReviews() {
        ...
        Response setMetadataBlocks = UtilIT.setMetadataBlocks(collectionAliasReviews, JsonUtil.createArrayBuilder().add("citation").add("rubric_trusteddatadimensionsintensities"), apiTokenReviewer);
                                ...
                                .add("citation", JsonUtil.createObjectBuilder()
                                        .add("fields", JsonUtil.createArrayBuilder()
                                                ...
                                                .add(JsonUtil.createObjectBuilder()
                                                        ...
                                                        .add("multiple", false)
                                                        .add("typeName", "itemReviewed"))))
                                .add("rubric_trusteddatadimensionsintensities", JsonUtil.createObjectBuilder()
                                        .add("fields", JsonUtil.createArrayBuilder()
                                                .add(JsonUtil.createObjectBuilder()
