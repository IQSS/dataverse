...
public class MailUtilTest {
    ...
    public void testSubjectCreateDataverse() {
        ...
        assertEquals("LibraScholar: Your collection has been created", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName, null));
    }
    ...
    public void testSubjectMapLayerUpdated() {
        ...
        assertEquals("LibraScholar: WorldMap layer added to data project", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName, null));
    }
    ...
    public void testSubjectCreateDataset() {
        ...
        assertEquals("LibraScholar: Your data project has been created", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName, null));
    }
    
    @Test
    public void testSubjectSubmittedDS() {
        userNotification.setType(UserNotification.Type.SUBMITTEDDS);
        assertEquals("LibraScholar: Your data project has been submitted for review", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName, null));
    }
    
    @Test
    public void testSubjectPublishedDS() {
        userNotification.setType(UserNotification.Type.PUBLISHEDDS);
        assertEquals("LibraScholar: Your data project has been published", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName, null));
    }
    
    @Test
    public void testSubjectReturnedDS() {
        userNotification.setType(UserNotification.Type.RETURNEDDS);
        assertEquals("LibraScholar: Your data project has been returned", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName, null));
    }
    ...
    public void testSubjectFileSystemImport() {
        ...
        assertEquals("Data Project LibraScholar has been successfully uploaded and verified", MailUtil.getSubjectTextBasedOnNotification(userNotification, rootDataverseName , null));
    }
