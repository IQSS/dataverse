...
//        passwordValidatorService = new PasswordValidatorServiceBean();
    ...
    public void testDifferentPasswordsAndSettings() {
        ...
        final List<Params> paramsList = Arrays.asList(new Params[]{
            ...
            // FIXME: Shouldn't 20 blank spaces fail the numberOfRepeatingCharactersAllowed rule?
            new Params(0, "                              ", expired, expirationDays, expirationMinLength, 30, maxLength, minLength, dictionary, numberOfCharacters, characterRulesHarvardLevel3, numberOfRepeatingCharactersAllowed), //For some reason, whitespace doesn't count in the repeating rule?
