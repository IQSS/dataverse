...
See also [#5621](https://github.com/IQSS/dataverse/pull/5621)
...
See also [#10581](https://github.com/IQSS/dataverse/issues/10581)
...
See also [#8243](https://github.com/IQSS/dataverse/pull/8243)
...
[See Settings.](#database-settings)

See also [#8985](https://github.com/IQSS/dataverse/pull/8985)
...
- *Improved Indexing with Compound Fields:* When using an external vocabulary service with compound fields, you can now specify which field(s) will include additional indexed information, such as translations of an entry into other languages. This is done by adding the `indexIn` in `retrieval-filtering`. [#10505](https://github.com/IQSS/dataverse/pull/10505)
...
- *Broader Support for Indexing Service Responses:* Indexing of the results from `retrieval-filtering` responses can now handle additional formats including Json Arrays of Strings and values from arbitrary keys within a JSON Object. [#10505](https://github.com/IQSS/dataverse/pull/10505)

- *HTTP Headers:* You are now able to add HTTP request headers required by the service you are implementing [#10331](https://github.com/IQSS/dataverse/pull/10331)

- *Flexible params in retrievalUri:* You can now use `managed-fields` field names as well as the `term-uri-field` field name as parameters in the `retrieval-uri` when configuring an external vocabulary service. `{0}` as an alternative to using the `term-uri-field` name is still supported for backward compatibility. Also you can specify if the value must be url encoded with `encodeUrl:`. [#10404](https://github.com/IQSS/dataverse/pull/10404)
...
See also [#9739](https://github.com/IQSS/dataverse/pull/9739)
...
See also [#10022](https://github.com/IQSS/dataverse/pull/10022)
...
See also [#10371](https://github.com/IQSS/dataverse/pull/10371)
...
See also [#10339](https://github.com/IQSS/dataverse/pull/10339)
...
See also [#10611](https://github.com/IQSS/dataverse/pull/10611)
...
See also [#10468](https://github.com/IQSS/dataverse/pull/10468)
...
See also [#10561](https://github.com/IQSS/dataverse/pull/10561)
...
See also [#10570](https://github.com/IQSS/dataverse/pull/10570)
...
See also [#10503](https://github.com/IQSS/dataverse/pull/10503)
...
See also [#10116](https://github.com/IQSS/dataverse/pull/10116)
...
See also [#9729](https://github.com/IQSS/dataverse/pull/9729)
...
See also [#10236](https://github.com/IQSS/dataverse/pull/10236)
...
See also [#10466](https://github.com/IQSS/dataverse/pull/10466)
...
See also [#10568](https://github.com/IQSS/dataverse/pull/10568)
...
See also [#10242](https://github.com/IQSS/dataverse/pull/10242)
...
See also [#10330](https://github.com/IQSS/dataverse/pull/10330)
...
See also [#10491](https://github.com/IQSS/dataverse/pull/10491)
...
See also [#10477](https://github.com/IQSS/dataverse/pull/10477)
...
See also [#10565](https://github.com/IQSS/dataverse/pull/10565)
