...
- The quality of the OpenAPI document has been greatly improved. See [the guides](https://guides.dataverse.org/en/6.12/api/getting-started.html#getting-the-openapi-document) and #12439.
- Added the ability to set and view the guestbookRoot setting of a collection. See [the guides](https://guides.dataverse.org/en/6.12/api/native-api.html#create-a-dataverse-collection), #12459, and #12611.
...
See [the guides](https://guides.dataverse.org/en/6.12/installation/config.html#reported-working-s3-compatible-storage), #12413, and #12660.
...
- If you are adding or updating Dataverse APIs you are now required to add OpenAPI annotations. See [the guides](https://guides.dataverse.org/en/6.12/developers/api-design.html#openapi) and #12439.
...
1. Double check `http request-timeout-seconds` setting.
