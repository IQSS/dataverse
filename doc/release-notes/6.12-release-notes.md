...
- The DDI metadata export for tabular files has been changed to avoid unnecessary database queries, remove unused methods, and add consistency checks. See #12642.
