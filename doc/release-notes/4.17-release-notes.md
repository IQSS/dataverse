...
Dataverse now allows installation administrators to configure the session timeout for users. Setting this lower will release system resources as configured and will result in better performance throughout a dataverse installation. 

## Major Use Cases

Newly-supported use cases in this release include:

- As a user, I can launch and utilize tools that allow me to work across the code, data, and other files in a dataset. 
...
If you have any external tools enabled on your Dataverse installation, you need to update the manifest.json files to indicate the appropriate scope of the tool

`"scope": "file",`

### New Database Settings

User Timeout Setting?

## Notes for Tool Developers and Integrators

### Dataset Level Explore Tools

Tool developers can now define the scope of an external tool as file or dataset. This will allow tools to appear for selection at the dataset or file level. For more information, check out the Guides section on <a href=http://guides.dataverse.org/en/4.17/installation/external-tools.html/>External Tools</a>.
