...
### New canDownloadAtLeastOneFile API

The GET canDownloadAtLeastOneFile (/api/datasets/{id}/versions/{versionId}/canDownloadAtLeastOneFile) endpoint has been created.
...
### Endpoint Extended: Datasets, Dataverse Collections, and Datafiles
