...
[New microprofile settings](#new-microprofile-settings)
...
For a list of new settings see the section below:
...
# New Settings 
 ...
 <a id="new-microprofile-settings"></a>
### New microprofile settings : [Go back](#multiple-pid-sup)
