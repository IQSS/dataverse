...
For installations that were previously running on Dataverse Software 4.x, and have a domain.xml that originated from Glassfish, the below JVM Options have been added. If your Dataverse installation was first installed on the 5.x series, these JVM options should already be present.
