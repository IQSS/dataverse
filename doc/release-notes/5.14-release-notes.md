...
- There are 2 ways to regenerate the schema: By collecting the output of the Dataverse fields API and feeding it to the `update-fields.sh` script that we supply, as in the example below (modify the command lines as needed):
```
