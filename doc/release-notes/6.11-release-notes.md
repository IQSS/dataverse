...
A new checkbox called "Show Historical Requests" has been added to the permissions page for a data file. Checking the box will show the number of times access has been granted or denied by user. See #8013 and #12012.
