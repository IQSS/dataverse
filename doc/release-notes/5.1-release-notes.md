...
- Multipart API upload (Issue #6763, PR #6995)
...
- Shapefiles bug (Issue #6873, PR #7279)
- Zipper Duplicate Names (Issue [#80](https://github.com/IQSS/dataverse.harvard.edu/issues/80), PR #7276)
- Zipper Folders (Issue #7255, PR #7258)
- API for Solr cleanup (Issue #4225, PR #7211)

## Notes for Dataverse Installation Administrators

### New Option for Dataset-level Large File Uploads
