...
The following script will report the following for published dataverses, datasets, and files: dtype, name, owner, downloaded, published

:download:`activity.sql <../_static/api/activity.sql>`
