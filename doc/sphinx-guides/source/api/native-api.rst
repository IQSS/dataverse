...
- Disable the user's ability to log in to the Dataverse installation
- Remove the user's access from all datasets and files
...
.. _remove-role-assignments:

Remove Role Assignments of Role Assignee
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Delete all role assignments of a role assignee (i.e. a user or a group)::

    DELETE http://$SERVER/api/admin/assignments/assignees/$identifier

Note that ``identifier`` can contain slashes (e.g. ``&ip/-users``).
