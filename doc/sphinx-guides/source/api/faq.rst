...
What Are Common Use Cases for Dataverse Platform APIs?
----------------------------------------------------------
...
Where Can I Find Examples of Using Dataverse Platform APIs?
-----------------------------------------------------------
...
The :doc:`sword` is based on a standard, works fine, and is fully supported, but much more development effort has been going into the :doc:`native-api`, which is not based on a standard. It is specific to the Dataverse Platform.
...
There are so many Dataverse Platform APIs that a single page in this guide would probably be overwhelming. See :ref:`list-of-dataverse-apis` for links to various pages.
