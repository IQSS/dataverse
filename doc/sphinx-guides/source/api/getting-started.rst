...
If you are a researcher or curator who wants to automate parts of your workflow, this section should help you get started. The :doc:`intro` section lists resources for other groups who may be interested in Dataverse Platform APIs such as developers of integrations and support teams.
...
Many Dataverse Platform APIs require an API token.
...
If you're looking for some inspiration for how you can use the Dataverse Platform APIs, there are open source projects that integrate with the Dataverse Platform listed in the :doc:`apps` section.
