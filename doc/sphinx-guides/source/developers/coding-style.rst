...
The Netbeans formatting syntax appears not to be documented anywhere, however from an initial approixmation `astyle --mode=java --style=attach --add-braces ${source_file}` is reasonably close.
