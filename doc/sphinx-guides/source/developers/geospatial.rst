...
Geoconnect works as a middle layer, allowing geospatial data files in your Dataverse installation to be visualized with Harvard WorldMap. To set up a Geoconnect development environment, you can follow the steps outlined in the `local_setup.md <https://github.com/IQSS/geoconnect/blob/master/local_setup.md>`_ guide. You will need Python and a few other prerequisites.

As mentioned under the :ref:`architecture` section of Preparation in the Installation Guide, Geoconnect is an optional component of the Dataverse Platform, so this section is only necessary to follow it you are working on an issue related to this feature.

How Your Dataverse Installation Ingests Shapefiles
--------------------------------------------------
