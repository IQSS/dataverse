...
Payara 6.2022.1 or higher is required.

To install Payara, run the following commands:

``cd /usr/local``

``sudo curl -O -L https://s3.eu-west-1.amazonaws.com/payara.fish/Payara+Downloads/6.2022.1/payara-6.2022.1.zip``

``sudo unzip payara-6.2022.1.zip``
