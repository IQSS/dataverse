...
- R, rApache, Zelig, and TwoRavens: `TwoRavens: Tabular Data Exploration` (disabled for now) describes the feature and :doc:`r-rapache-tworavens` describes how to install these components. :doc:`external-tools` explains how third-party tools like TwoRavens can be added to Dataverse.
