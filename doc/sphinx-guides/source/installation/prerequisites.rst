...
Payara 6.2022.1.Alpha3 is recommended. Newer versions might work fine. Regular updates are recommended.
...
- Download and install Payara (installed in ``/usr/local/payara6`` in the example commands below)::
	...
	# wget https://s3.eu-west-1.amazonaws.com/payara.fish/Payara+Downloads/6.2022.1.Alpha3/payara-6.2022.1.Alpha3.zip
	# unzip payara-6.2022.1.Alpha3.zip
