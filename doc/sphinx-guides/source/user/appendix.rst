...
- `Journal Metadata <https://docs.google.com/spreadsheets/d/13HP-jI_cwLDHBetn9UKTREPJ_F4iHdAvhjmlvmYdSSw/edit#gid=8>`__: not based on any particular standard. Vocabulary for "type of article" taken from `JATS <https://jats.nlm.nih.gov>`__. (`see .tsv version <https://github.com/IQSS/dataverse/blob/master/scripts/api/data/metadatablocks/journal.tsv>`__).
