...
All file formats are supported, up to  20GB per file for the Harvard Dataverse. Please contact support@dataverse.org if you need to upload a file that is larger than 20GB. You can also add descriptions and categorize each of them by adding tags.
