...
if [ ! -e dv/deps/payara-5.2021.8.zip ]; then
	echo "payara dependency prep"
	# no more fiddly patching :)
	wget https://s3-eu-west-1.amazonaws.com/payara.fish/Payara+Downloads/5.2021.8/payara-5.2021.8.zip  -O dv/deps/payara-5.2021.8.zip
fi
