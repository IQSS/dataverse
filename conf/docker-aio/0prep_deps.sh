...
if [ ! -e dv/deps/payara-6.2022.1.Alpha3.zip ]; then
	echo "payara dependency prep"
	wget https://s3.eu-west-1.amazonaws.com/payara.fish/Payara+Downloads/6.2022.1.Alpha2/payara-6.2022.1.Alpha3.zip -O dv/deps/payara-6.2022.1.Alpha3.zip
fi
